...
class RunningMeanStd(object):
    ...
    def __init__(self, epsilon=1e-2, shape=()):
        ...
        self.var_list = [self._sum, self._sumsq, self._count]
        self.getflat = U.GetFlat(self.var_list)
        self.setfromflat = U.SetFromFlat(self.var_list, dtype = tf.float64)
    ...
    def sync(self):
        ...
        #import ipdb
        #ipdb.set_trace()
        #print('syncing from rank', self.comm.Get_rank())
